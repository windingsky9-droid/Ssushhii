...
| | |
|---|---|
| Products | Over-ear headphones, cosmetic pump bottle, table lamp, three-legged side table, bookshelf speaker |
| Configurations | 30 (six colourways per product, each with its own finish, hardware and trim) |
